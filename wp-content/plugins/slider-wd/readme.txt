...
*   **Easy to set up, use and customize** - Slider WD was developed with users in mind. Anyone from beginners to WordPress profs will be able to easily create and customize the sliders without any coding skills. 
*   **Get Support** - The team behind Slider WD plugin provides timely and effective support to all its users. We keep standards high and response time low. 
...
= Slider WD main features include: =

*   Responsive sliders      
*   Unlimited sliders and unlimited slides     
...
*   Custom design for the bullets and navigation buttons   
*   Timer bar   
...
= 1. How can I add images to slider? =
...
= 2. Can I add video slides to slider? =
...
= 3. Is it possible to make custom style changes to a slide? =

Use CSS tab of Slider Settings to write additional CSS code and apply custom styles to the slideshow. Note, that these changes will override the original styles of the slider.


= 4. Can I publish slider as a widget? =
...
= 5. How can I add layers to slides? =
...
= 6. Can I move sliders to one site to another? =
...
= 7. How do I insert the WordPress Slider into a Page or a Post? =
...
= 8. Can I customize Slider settings to better fit my needs? =
...
= 9. Can I use Slider WD to create different sliders for different pages? =
